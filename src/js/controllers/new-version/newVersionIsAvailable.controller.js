(() => {
  ...
  function NewVersionIsAvailableCtrl($scope, $modalInstance, go, newVersion) {
    ...
    $scope.openDownloadLink = function () {
      let link = `https://github.com/travelflex/travelflex/releases/tag/v${newVersion.version}`;
      if (navigator && navigator.app) {
        link = 'https://play.google.com/store/apps/details?id=org.travelflex.client';
      }
