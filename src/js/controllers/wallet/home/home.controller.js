...
(() => {
  ...
  function HomeCtrl($scope, $rootScope, animationService, $timeout, profileService, correspondentListService, $modal, lodash, go) {
    ...
    const viewContentLoaded = function () {
      ...
      $rootScope.randPic = `../../../../../public/img/pic-${Math.floor(Math.random() * 10)}.jpg`;
    ...
    vm.buyTravelFlex = function () {
      const buyTravelFlexUrl = 'https://daguniversity.com/en';
      go.openExternalLink(buyTravelFlexUrl);
    };
